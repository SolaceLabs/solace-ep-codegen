 ...
 */
package com.solace.ep.codegen.mapper.sap.iflow;
...
import com.solace.ep.codegen.mapper.MapUtils;
import com.solace.ep.codegen.mapper.model.MapFlow;
import com.solace.ep.codegen.mapper.model.MapMuleDoc;
import com.solace.ep.codegen.mapper.model.MapSubFlowEgress;
import com.solace.ep.codegen.mapper.sap.iflow.model.bpmn_ifl_ext.TSapIflowProperty;
import com.solace.ep.codegen.mapper.sap.iflow.model.config.SapIflowExtensionConfig;
import com.solace.ep.codegen.mapper.sap.iflow.model.config.SapIflowExtensionConfig.ProcessExt;
...
public class SapIflowMapper {
    ...
    private final com.solace.ep.codegen.mapper.sap.iflow.model.bpmn_ifl_ext.ObjectFactory 
                    iflFactory = new com.solace.ep.codegen.mapper.sap.iflow.model.bpmn_ifl_ext.ObjectFactory();
     ...
     */
    private void mapConsumerToIflow( final MapFlow consumer, final String startParticipantId ) {
        ...
        final TMessageFlow messageFlow = createSubscribeMessageFlow(
            consumer, 
            startParticipantId, 
            receiverProcess );
     ...
     */
    private void mapPublisherToIflow( final MapSubFlowEgress publisher, final String endParticipantId ) {
        ...
        final TProcess eventGeneratorProcess = createEventGeneratorProcess(publisher);
     ...
     * @return
     */
    private TProcess createEventGeneratorProcess( final MapSubFlowEgress publisher ) {
